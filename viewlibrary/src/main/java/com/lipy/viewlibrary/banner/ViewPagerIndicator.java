package com.lipy.viewlibrary.banner;
...
public class ViewPagerIndicator extends View {
    ...
    public ViewPagerIndicator setItemColor( int color,  int selected) {
        this.mItemDrawable = genDrawable(color);
        this.mItemDrawableSelected = genDrawable(selected);
        return this;
    }

    public ViewPagerIndicator setItemDrawable( Drawable normal,  Drawable selected) {
