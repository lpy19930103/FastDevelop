package com.lipy.viewlibrary.panel;
...
public abstract class PanelListAdapter {
    ...
    private void reorganizeViewGroup() {
        ...
        RelativeLayout.LayoutParams lp_tv_title = new RelativeLayout.LayoutParams(1, titleHeight);
...
//        pl_root.addView(lv_column, lp_lv_column);//// TODO: 2017/6/8
