...
public final class ActionRequest {
    ...
    public static class Builder {
        ...
        private Builder(ActionRequest request) {
    ...
    private ActionRequest(String url, String method, Headers headers, RequestBody body, Object tag) {
    ...
    @NonNull
    public ActionRequest addParameter(String key, Object o) {
        if (o instanceof String) {
     ...
     */
    @NonNull
    public ActionRequest addFilesByUri(String key, List<Uri> uris) {
